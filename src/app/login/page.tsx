  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#8B5CF6]/5 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#8B5CF6]/3 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#A1A1AA] mt-2">
            Đăng nhập để tiếp tục mua sắm game
          </p>
        </div>
        ...
        <div className="bg-[#111118] border border-white/10 rounded-2xl p-8 space-y-6 glow-purple">
          ...
          <Button
            ...
            disabled={loading}
            variant="outline"
            className="w-full h-12 border-white/10 bg-white/5 text-white hover:bg-white/10 hover:text-white gap-3 text-sm font-medium"
          >
          ...
          <form action={handleEmailLogin} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-12 bg-[#8B5CF6] hover:bg-[#A78BFA] text-white font-medium text-sm transition-all duration-200"
            >
              {loading ? (
